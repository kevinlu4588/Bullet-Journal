...
import cs3500.pa05.controller.handlers.file.OpenEventHandler;
...
/**
 * Represents an open journal controller.
 */
public class OpenJournalController extends AbstractSubController {
   ...
   */
  public OpenJournalController(Stage stage, JournalInteractable journal, MasterController master) {
  ...
  private void loadRealPopUp() {
    ...
    EventHandler<ActionEvent> finish = new OpenEventHandler(this.stage, this.popup,
